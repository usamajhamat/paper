...
<head>
    ...
    <link href="{{asset('public/assets/urdufonts/JameelNooriNastaleeqRegular.ttf')}}">
...
<body class="app sidebar-mini rtl no-select">
    ...
    <div class="page-main">
        <div class="app-header header py-1 d-flex">
            <div class="container-fluid">
                <div class="d-flex">
                    <a class="header-brand" href="{{route('client-home')}}">
                        ...
                        <h4 style="margin-top:2%;font-family:Arial;letter-spacing:-2px;color:#FF5B6B;"><b>ONE CLICK TEST SOLUTION<br><h6 style="letter-spacing:0;"><b>Version 8.0</b></h6></b></h4>
                    </a>
        ...
        <aside class="app-sidebar">
            ...
            <ul class="side-menu">
                @if($client->client_role!='Teacher')
                    <li>
                        <a class="side-menu__item bg-primary text-white" href="javascript:void(0)"><span class="side-menu__label blink">Valid Till: {{\Carbon\Carbon::parse($client->expired_at)->format('d-M-Y')}}</span></a>
                    </li>
                @endif
                <li>
                    <a class="side-menu__item" href="{{route('client-home')}}"><i class="side-menu__icon fa fa-home"></i><span class="side-menu__label">Dashboard</span></a>
                </li>
                 @if($client->client_role=='Teacher')
                    <li>
                        <a class="side-menu__item" href="#"><i class="side-menu__icon fas fa-book-open"></i><span class="side-menu__label">Generate Paper</span></a>
                    </li>
                @endif
                <li>
                    <a class="side-menu__item" href="{{route('client-change-password')}}"><i class="side-menu__icon fa fa-key"></i><span class="side-menu__label">Change Password</span></a>
                </li>
                <li>
                    <a class="side-menu__item" href="{{route('client-logout')}}"><i class="side-menu__icon fas fa-sign-out-alt"></i><span class="side-menu__label">Logout</span></a>
                </li>
            </ul>
        </aside>
