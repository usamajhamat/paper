            ...
            @elseif($medium->medium_name=='English')
                ...
                @foreach($questions as $question)
                    <div class="TableHover EnglishAlign upper"  data-id="{{$question->q_id}}"  id="{{$count}}" style="margin-top: 13px;">
                        ...
                        </li><li class="correctAnswer EnglishMcqs" thiscorrect="1-(C)"><span>(C)</span>{!! $question->eng_c !!}
                        </li><li class="EnglishMcqs"><span>(D)</span>{!! $question->eng_d !!}
                        </li><div style="clear:both;"></div></div>
                    {{--<div class="TableHover EnglishAlign upper" data-id="{{$question->q_id}}"  id="{{$count}}" style="margin-top: 13px;">--}}
                        {{--<div class="EnglishDiv"><span>{{$count}}</span>{!! $question->question_english !!}</div>--}}
                        {{--<div style="clear: both;"></div>--}}
                        {{--@if($board==1)--}}
                            {{--<div class="Qboards">--}}
                                {{--@if($question->question_board!=null)--}}
                        ...
                        {{--@endif--}}
                        {{--<div style="clear: both;"></div>--}}
                        {{--<li class="EnglishMcqs"><span>(A)</span>{!! $question->eng_a !!}</li>--}}
                        {{--<li class="correctAnswer EnglishMcqs" thiscorrect="1-(B)"><span>(B)</span>{!! $question->eng_b !!}</li>--}}
                        {{--<li class="EnglishMcqs"><span>(C)</span>{!! $question->eng_c !!}</li>--}}
                        {{--<li class="EnglishMcqs"><span>(D)</span>{!! $question->eng_d !!}</li>--}}
                        {{--<div style="clear: both;"></div>--}}
                    {{--</div>--}}
                    @php $count++; @endphp
                @endforeach
...
@if(in_array($type,\App\Models\Helper::addType3()))
    <div class="QuestionDiv" id="chooseQuestionsByChapterIDs">
        <div class="ParagraphsType">
            ...
            @elseif($medium->medium_name=='Urdu')
                @foreach($questions as $question)
                    <div class="TableHover UrduAlign upper" data-id="{{$question->q_id}}" id="{{$count}}" style="">
                        <div class="UrduDiv">
                            <span class="roman">{{$count}}</span>
                            <span style="margin-left:5px;">.</span>
                             {!! $question->question_urdu !!}
