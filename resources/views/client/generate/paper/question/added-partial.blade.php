{{--<link href="https:///Content/GeneratePaper.css" rel="stylesheet" />--}}
...
<style>
    ...
    .SelectedQuestion {
        background-color:rgba(162 255 156 / 50%);
    ...
    <div class="QuestionType">
        ...
        @if($medium->medium_name=='Dual')
            @foreach($questions as $question)
                <div class="TableHover EnglishAlign" id="{{$count}}" style="margin-top: 13px;">
        ...
        @elseif($medium->medium_name=='Urdu')
            @foreach($questions as $question)
                <div class="TableHover EnglishAlign" data-id="{{$question->q_id}}" id="{{$count}}" style="">
        ...
        @elseif($medium->medium_name=='English')
            @foreach($questions as $question)
                <div class="TableHover EnglishAlign" data-id="{{$question->q_id}}" id="{{$count}}" style="font-family: 'Times New Roman', Times, serif;">
                    <div class="EnglishDiv">
                        <span class="roman">{{$count}}.</span>
                        <span style="margin-right:5px;"></span>
                        <p>{!! $question->question_english !!}</p>
