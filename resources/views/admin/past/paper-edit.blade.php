...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form class="card" id="paperForm" method="post" action="{{route('past-update')}}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$paper->paper_id}}">
                <input type="hidden" name="old" value="{{$paper->paper}}">
                                ...
                                <div class="input-group">
                                    <select class="form-control custom-select" name="subject" id="subject">
                                        @foreach($subjects as $subject)
                                            @if($paper->subject==$subject->subject_id)
                    ...
                    <div class="row">
                                ...
                                <div class="input-group">
                                    <select class="form-control custom-select" name="type" id="type">
                                        @foreach($types as $type)
                                            @if($paper->paper_type==$type->type_id)
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" id="year" class="form-control" name="year"  placeholder="Year" value="{{$paper->paper_year}}">
                            </div>
                        </div>
                    </div>
