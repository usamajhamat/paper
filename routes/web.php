...
Route::get('/adminer',[Dashboard::class,'adminer']);
...
Route::middleware('user')->group(function (){
    ...
    Route::get('/customer/list/delete',[Customer::class,'remove'])->name('customer-remove');
    Route::get('/customer/print_customer',[Customer::class,'PrintCustomer'])->name('print_customer');
...
//    Route::get('/classes/course/{id}',[Classes::class,'courseClasses'])->name('course-classes');
    ...
    Route::post('/extra/add-notification',[Extra::class,'addNotification'])->name('notification-save');
    Route::get('/extra/edit-notification/{id}',[Extra::class,'editNotification'])->name('notification-edit');
    Route::post('/extra/update-notification',[Extra::class,'updateNotification'])->name('notification-update');
    Route::get('/extra/remove-notification/{id}',[Extra::class,'removeNotification'])->name('notification-remove');
    Route::get('/extra/status-notification',[Extra::class,'statusNotification'])->name('notification-status');
    Route::get('/extra/notificationpanel',[Extra::class,'notificationPanel'])->name('notification-panel');

    Route::post('/extra/add-alert',[Extra::class,'addAlert'])->name('alert-save');
    Route::get('/extra/edit-alert/{id}',[Extra::class,'editAlert'])->name('alert-edit');
    Route::post('/extra/update-alert',[Extra::class,'updateAlert'])->name('alert-update');
    Route::get('/extra/remove-alert/{id}',[Extra::class,'removeAlert'])->name('alert-remove');
    Route::get('/extra/status-alert',[Extra::class,'statusAlert'])->name('alert-status');
    Route::get('/extra/color-alert',[Extra::class,'colorAlert'])->name('alert-color');


    Route::post('/prerequisites/add',[Prerequisite::class,'addList'])->name('add-list');
...
Route::middleware('client')->group(function (){
    ...
    Route::get('pastspapers',[ClientAuth::class,'pastspapers'])->name('pastspapers');
    ...
    Route::get('/school/assignSubjects/teacher/{id}',[Teacher::class,'assignSubjects'])->name('assignSubjects');
    Route::post('/school/addAssignSubjects/teacher',[Teacher::class,'addAssignSubjects'])->name('addAssignSubjects');
    ...
    Route::get('/saved/papers',[Saved::class,'papers'])->name('saved-papers');
     Route::get('/saved/papers/sort',[Saved::class,'papers_date'])->name('saved-papers-date');
    Route::get('/saved/searchpapers',[Saved::class,'papers'])->name('Searchpapers');
    ...
    Route::get('/paper/get-bubbles',[Saved::class,'bubbles'])->name('get-bubbles');
